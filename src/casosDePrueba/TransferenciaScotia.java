...
/*	if(UI_Transferir.validarPago()==false)
	...
	Frmwrk.logResultadoFailed((System.nanoTime() - startTime), "Fallo en la validación entre datos enviados y los registrados en la base de datos. "
			+ "Revisar los archivos de evidencia (contienen detalles para poder realizar la validación manual)", Config.globalCP);	
	}
	else
