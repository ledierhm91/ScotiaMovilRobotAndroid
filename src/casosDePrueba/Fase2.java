...
public class Fase2 {	
	...
	Config.globalDescrip = "Se realiza el login ingresando valores vacios y erroneos de Usuario, PIN y contraseÃ±a";
	//----------------------------------------------------------	
...
/*	if(UI_Transferir.validarPago()==false)
	...
	Frmwrk.logResultadoFailed((System.nanoTime() - startTime), "Fallo en la validaciï¿½n entre datos enviados y los registrados en la base de datos. "
			+ "Revisar los archivos de evidencia (contienen detalles para poder realizar la validaciï¿½n manual)", Config.globalCP);	
	}
	else
...
/*	if(UI_Transferir.validarPago()==false)
	...
	Config.globalDescrip = "Se realizan validaciones en el formulario Transferencia Plaza. Campos vacíos y valores erroneos";
	//----------------------------------------------------------	 	
	UI_Menu_Izq fp = PageFactory.initElements(Config.driver, UI_Menu_Izq.class);
	fp.home();
	fp.transferir();	
